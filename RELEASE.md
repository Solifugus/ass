...
4. `PLAN.md`, `README.md`, and `COMPATIBILITY.md` reflect what ships
   (regenerate the matrix: `ass test corpus/`).
...
`CGO_ENABLED=0` cross-builds; see `sql/DECISION.md` for the trade-off.
