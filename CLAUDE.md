...
- `dbio/` — external-database LIBNAME engines (`table.Backend`/`table.WriteBackend` over `database/sql`); read + write for Postgres/SQL Server/Oracle (pure-Go drivers) and SQLite (CGo). See `docs/databases.md`
