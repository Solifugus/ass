...
Generated from the compatibility corpus via `ass test corpus/` (2026-06-20; PUT output hold).
...
| Executed | 49 (100.0%) |
| Passed | 49 (100.0%) |
| Value-verified | 23 items assert dataset values; all match |
