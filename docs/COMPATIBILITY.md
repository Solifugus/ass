...
Generated from the compatibility corpus via `ass test corpus/` (2026-06-21).
...
| Executed | 39 (100.0%) |
| Passed | 39 (100.0%) |
| Value-verified | 13 items assert dataset values; all match |
